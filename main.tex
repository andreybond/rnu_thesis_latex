...
\setthesisscope
  {23}% Total pages (count final PDF)
  {1}% Total tables (count from List of Tables)
  {1}% Total figures (count from List of Figures) 
  {1}% Total algorithms (count from List of Algorithms)
  {1}% Total listings (count from List of Listings)
  {1}% Total annexes (count appendix chapters)
  {1}% Total references (count bibliography entries)
